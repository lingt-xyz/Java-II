// *******************************************************************
// FileIO10.java By: Aiman Hanna (C) 1993 - 2017
// This program provides a pre-introduction to the File class. T
// he program actually does not introduce that class; rather it 
// explain why it is needed. Notice the output of this program. 
// Do you see the type of damages that such coding combined with 
// a small careless, or possibly intentionally, input from user
// might cause? See FileIO11.java for more information. 
// 
// Key Points:
// 1) The File Class. 
// *******************************************************************
...
StudentInfo4.txt StudentInfo4.txt
Attempting to open and display the contents of file: StudentInfo4.txt.

Here are the contents of file StudentInfo4.txt BEFORE performing the coping operation:
===================================================================================
...
Here are the contents of file StudentInfo4.txt AFTER copying operation:
==================================================================

Here are the contents of file StudentInfo4.txt:
======================================================

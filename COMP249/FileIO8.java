// *******************************************************************
// FileIO8.java By: Aiman Hanna (C) 1993 - 2017
// This program illustrates input and output files further.
// The program is almost identical to FileIO7.java, but if 
// fixes the problem that this program had. What is the difference? 
//
// Key Points:
...
/* Contents of StudentInfo2_backup.txt file after executing the program 
This file includes the current registration of Comp 201
=======================================================
Name		ID#
----		---

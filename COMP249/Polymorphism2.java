// *******************************************************************
// Polymorphism2.java By: Aiman Hanna (C) 1993 - 2017
// This program illustrates the subject of "polymorphism" in relation to 
// static methods. In specific, Java does NOT use late binding for static 
// methods; rather it uses "static binding", which occurs at compile time.
//
// Note: In case a static function is overridden and is called by an object 
// of a class (instead of by the class name directly), the exact static 
// method that is executed is determined by the "object name" and not by
// the object that "it references". This may produce, or be considered as,
// an unexpected behavior, and so you should be aware of it. Again the reason 
// behind that lies in the fact that Java uses static/early binding for static 
// methods. See the end of this program for illustration on that case. 
...
class Bus extends Vehicle{
	...
	{
		// Do not increment the numOfCreatedObjects since it is done in the called constructor
...
public class Polymorphism2{
	...
	public static void main(String[] args) {
		...
		v1 = b1;	// Since a Bus is a Vehicle, this is okay 
					// Notice that b1 = v1; will be illegal since a 
					// a Vehicle is NOT a Bus
...
Creating a vehicle object using parameterized constructor ....
The number of created Vehicle objects so far is 2.
...
The number of created Vehicle objects so far is 5.
...
Creating a vehicle object using parameterized constructor ....
Creating a car object using parameterized constructor ....
The number of created Car objects so far is 2.
...
Creating a car object using parameterized constructor ....
Creating a sport car object using parameterized constructor ....
The number of created SportCar objects so far is 2.
...
Creating a sport car object using parameterized constructor ....
Creating a race car object using parameterized constructor ....
The number of created RaceCar objects so far is 2.
